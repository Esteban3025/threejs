...
var Box3 = class {
  ...
  setFromArray(array2) {
    ...
    for (let i = 0, il = array2.length; i < il; i += 3) {
      this.expandByPoint(_vector4.fromArray(array2, i));
    }
    return this;
  }
  /**
...
var Object3D = class _Object3D extends EventDispatcher {
  ...
  worldToLocal(vector) {
    this.updateWorldMatrix(true, false);
    return vector.applyMatrix4(_m13.copy(this.matrixWorld).invert());
  }
  /**
  ...
  lookAt(x, y, z) {
    ...
    if (this.isCamera || this.isLight) {
      _m13.lookAt(_position, _target, this.up);
    } else {
      _m13.lookAt(_target, _position, this.up);
    }
    this.quaternion.setFromRotationMatrix(_m13);
    if (parent) {
      _m13.extractRotation(parent.matrixWorld);
      _q1.setFromRotationMatrix(_m13);
  ...
  attach(object) {
    this.updateWorldMatrix(true, false);
    _m13.copy(this.matrixWorld).invert();
    if (object.parent !== null) {
      object.parent.updateWorldMatrix(true, false);
      _m13.multiply(object.parent.matrixWorld);
    }
    object.applyMatrix4(_m13);
    object.removeFromParent();
    object.parent = this;
    this.children.push(object);
...
var BufferGeometry = class _BufferGeometry extends EventDispatcher {
  constructor() {
    ...
    Object.defineProperty(this, "id", { value: _id2++ });
    this.uuid = generateUUID();
    this.name = "";
  ...
  applyQuaternion(q) {
    _m14.makeRotationFromQuaternion(q);
    this.applyMatrix4(_m14);
    return this;
  }
  rotateX(angle) {
    _m14.makeRotationX(angle);
    this.applyMatrix4(_m14);
    return this;
  }
  rotateY(angle) {
    _m14.makeRotationY(angle);
    this.applyMatrix4(_m14);
    return this;
  }
  rotateZ(angle) {
    _m14.makeRotationZ(angle);
    this.applyMatrix4(_m14);
    return this;
  }
  translate(x, y, z) {
    _m14.makeTranslation(x, y, z);
    this.applyMatrix4(_m14);
    return this;
  }
  scale(x, y, z) {
    _m14.makeScale(x, y, z);
    this.applyMatrix4(_m14);
    return this;
  }
  lookAt(vector) {
...
var Mesh = class extends Object3D {
  ...
  raycast(raycaster, intersects) {
    ...
    if (_sphere2.containsPoint(_ray.origin) === false) {
      if (_ray.intersectSphere(_sphere2, _sphereHitAt) === null) return;
    ...
    if (envNode.isTextureNode || envNode.isMaterialReferenceNode) {
      ...
      if (texture2 && texture2.isTexture) {
        ...
        if (mapping === EquirectangularReflectionMapping || mapping === EquirectangularRefractionMapping) {
          if (_cache.has(texture2)) {
            const cubeMap = _cache.get(texture2);
            ...
            if (isEquirectangularMapReady(image)) {
              ...
              _cache.set(texture2, renderTarget.texture);
...
var CubeMapNode_default = CubeMapNode;
...
function onTextureDispose(event) {
  ...
  const renderTarget = _cache.get(texture2);
  if (renderTarget !== void 0) {
    _cache.delete(texture2);
...
export {
  cubeMapNode,
  CubeMapNode_default as default
};
//# sourceMappingURL=three_src_nodes_utils_CubeMapNode__js.js.map
